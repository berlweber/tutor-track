...
urlpatterns = [
    ...
    path('assignment/<int:pk>/sessions/create/', views.SessionCreate.as_view(), name='session-create'),
    path('assignment/<int:pk>/adjustments/create/', views.AttendanceAdjustmentCreate.as_view(), name='adjustment-create'),
